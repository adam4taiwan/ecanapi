...
";
        ...
        public async Task<IActionResult> GetBaziZiweiAnalysis()
        {
            ...
            try
            {
                ...
                if (bzHasZiwei)
                {
                    ...
                    string bzMing = BzStripTrailingHeader(KbFilterZiweiContent(KbExtractPalaceSection(bzFullContent, "命宮"), KbGetPalaceStarsSet(bzPalaces, "命宮"), bzChartStars));
                    string bzOff  = BzStripTrailingHeader(KbFilterZiweiContent(KbExtractPalaceSection(bzFullContent, "事業宮"), KbGetPalaceStarsSet(bzPalaces, "官祿"), bzChartStars));
                    string bzWlt  = BzStripTrailingHeader(KbFilterZiweiContent(KbExtractPalaceSection(bzFullContent, "財帛宮"), KbGetPalaceStarsSet(bzPalaces, "財帛"), bzChartStars));
                    string bzSps  = BzStripTrailingHeader(KbFilterZiweiContent(KbExtractPalaceSection(bzFullContent, "夫妻宮"), KbGetPalaceStarsSet(bzPalaces, "夫妻"), bzChartStars));
                    string bzHlt  = BzStripTrailingHeader(KbFilterZiweiContent(KbExtractPalaceSection(bzFullContent, "疾厄宮"), KbGetPalaceStarsSet(bzPalaces, "疾厄"), bzChartStars));
                    ...
                    bool BzHasSiHua(string palaceName) =>
                        (!string.IsNullOrEmpty(bzSiHuaLu)   && KbPalaceSame(bzSiHuaLuPalace,   palaceName)) ||
        ...
        [Authorize]
        public async Task<IActionResult> GetDaiyunAnalysis([FromQuery] int years = 5, [FromQuery] int v = 1)
        {
            var identity = User.FindFirstValue(ClaimTypes.Email)
                         ?? User.FindFirstValue(ClaimTypes.Name)
                         ?? User.FindFirst("unique_name")?.Value;
        ...
        // ─── 江湖鐵口斷命 六親論斷靜態資料（年/月/日/時柱 × 干/支 × 十神）─────────
        // key 格式："{柱}{干|支}_{十神}"，干=天干十神觸發，支=地支本氣十神觸發
        private static readonly Dictionary<string, string> JianghuSixRel = new()
        {
            // ── 年柱 ──
            {"年干_正財", "年上正財祖業強，年下正財借祖光。日弱運行比劫運，父死異鄉有牽連。"},
            {"年支_正財", "年支若逢占正財，祖上必然有家產。年支若要正財現，富貴榮華在少年。"},
            {"年干_偏財", "年上偏財命中安，日弱克父定不偏，日主建旺財務好，父反高壽有財源，年月刑沖不算好，父東子西把家搬。"},
            {"年支_偏財", "支為偏財支出大。年支若要逢偏財，財官相後前程寬。"},
            {"年干_正官", "年上正官要占先，祖上有過功名權。"},
            {"年支_正官", "支為正官多高尚，祖上能把權來當。年支若要逢正官，祖上有權好命看。年支若要逢正官，祖上必然把兵當。"},
            {"年干_七殺", "年上七殺逢生旺，祖上威武又剛強，羊刃會殺方為好，祖上必把官來當。"},
            {"年支_七殺", "年支若要逢七殺，祖上剛強有名望。年支若要逢七殺，恐怕少運有災難。年支若要逢七殺，一生身體不算弱。"},
            {"年干_正印", "年上正印祖蔭深，先人有德積善功。幼年得長輩護佑，讀書求學有靠山。"},
            {"年支_正印", "年支若要逢正印，一代一代勝從前。年支若要逢正印，官印相生好命看。年支若要逢正印，父母有權在命上。"},
            {"年干_偏印", "年上偏印祖業偏，先人孤高難依傍。幼年環境多變動，自力更生走異鄉。"},
            {"年支_偏印", "支為偏印不太好，先富後貧祖飄蕩。年支若要逢偏印，以小失大不堪言。年支若要逢偏印，自力更生創家園。"},
            {"年干_食神", "年上食神祖業豐，衣食有餘樂無窮。祖上富足多積蓄，幼年生活不憂貧。"},
            {"年支_食神", "年支若要逢食神，衣食豐足妻子幫。年支若要逢食神，祖上富貴命里添。年支若要逢食神，祖業興旺本有錢。"},
            {"年干_傷官", "年上傷官祖業虧，先人個性難平息。聰明有才多波折，幼年家境不安穩。"},
            {"年支_傷官", "年支若要逢傷官，雖然富貴也不長。年支若要逢傷官，祖上受損，恐怕父母難保全。"},
            {"年干_比肩", "年上比肩財不聚，兄弟分家各奔馳。祖業難守財易散，幼年環境多競爭。"},
            {"年支_比肩", "年支若要逢比肩，財祿廣進弟兄幫。年支若要逢比肩，兄弟多了分財源。"},
            {"年干_劫財", "年上劫財祖業消，財星受損難逃掉。先人創業多波折，幼年家境欠安康。"},
            {"年支_劫財", "年支若要逢劫財，祖上家產借不上。年支若要逢劫財，祖上興旺沒幾天。"},
            {"年支_羊刃", "年支若要逢羊刃，好事難成不好辦。年支若要逢羊刃，祖上要基不算強。"},
            {"年支_建祿", "年支若要逢建祿，祖上一代本有權。"},
            // ── 月柱 ──
            {"月干_正財", "月上正財不一般，日柱建旺有財源。"},
            {"月支_正財", "支為正財逢生旺，一生富貴在命間。正財建祿最為好，全賴父母來周全。地支若要正財見，少年富貴本有財。"},
            {"月干_偏財", "月上偏財眾人財，意外之財命帶來。"},
            {"月支_偏財", "支為偏財能巧得，買賣手藝能掙錢。月支偏財逢身旺，妻妾情人有一排。"},
            {"月干_正官", "月上正官命格貴，父母嚴正重規矩。青年循規可出仕，功名富貴命中來。"},
            {"月支_正官", "月支若逢正官格，財官相生能掌權。月支再把正官現，生官發財命里該。支為正財官星旺，財官相生顯赫名。"},
            {"月干_七殺", "月上七殺性剛強，父母嚴厲規矩多。青年需有印星護，方可化殺建功業。"},
            {"月支_七殺", "月支若要地支逢七殺，身弱貧困命中安，宜逢正印化殺為佳。"},
            {"月干_正印", "月上正印母慈愛，學識豐富有依靠。青年讀書有靠山，一生貴人常相助。"},
            {"月支_正印", "月支若要逢正印，先財後印好命看。月支若要逢正印，一生保證有依賴。"},
            {"月干_偏印", "月上偏印多才藝，思維獨特走偏門。青年學業難專一，多學多問方有成。"},
            {"月支_偏印", "月支若要逢偏印，總想離家去求財。月支若要逢偏印，多學少成好逞能。"},
            {"月干_食神", "月上食神福氣厚，父母體貼多庇護。青年衣食不憂愁，技藝精通有口福。"},
            {"月支_食神", "月支再把食神現，父母攢下田和宅。"},
            {"月干_傷官", "月上傷官聰慧靈，才華出眾難受控。青年有才多孤傲，需學謙遜方順暢。"},
            {"月支_傷官", "月支若要逢傷官，聰明伶俐會攢錢。月支再把傷官現，破腹手足有大災。"},
            {"月干_比肩", "月上比肩兄弟多，財星分奪難獨享。青年需靠自身力，不依兄弟自奮強。"},
            {"月支_比肩", "月支若要逢比肩，兄弟姐妹爭家產。月支若要占比肩，獨立致富運難開。"},
            {"月干_劫財", "月上劫財財易散，兄弟競爭奪家產。青年理財需謹慎，開源節流方守財。"},
            {"月支_劫財", "月支再把劫財見，婚姻恐怕人破壞。"},
            {"月支_建祿", "正財建祿最為好，全賴父母來周全。"},
            // ── 日柱（日主=日干，僅看日支本氣十神）──
            {"日支_正財", "日帶正財得妻財，美貌賢妻能帶來，發財至富得內助，夫唱妻隨多恩愛。女命若把正財見，丈夫對你最關懷。正財若要逢正官，財官雙美無有災。正財若要逢七殺，配偶精明又強幹。正財逢空不太好，夫妻中年要分開。"},
            {"日支_偏財", "日帶偏財運不周，夫妻難以到白頭。偏財若要逢刑沖，恐怕夫妻沒長壽。偏財若要逢正官，財旺官旺事無憂。偏財若要逢傷官，夫妻半路鬧分手。"},
            {"日支_正官", "日主正官性聰明，古稱天上文曲星，一舉成名框天下。正官若要逢正財，此人必然有權柄，一生榮華能富貴，威名遠震人尊敬。正官若要逢傷官，運行傷官有災星。正官若要逢食神，衣食豐足命里逢。"},
            {"日支_七殺", "日帶七殺配偶精明強幹，主婚姻有壓力感。"},
            {"日支_食神", "日帶食神，衣食豐足，偏財逢食神晚年財源最豐厚。"},
            {"日支_傷官", "日支傷官，婚姻易有口舌是非，夫妻需相互包容。偏財若要逢傷官，夫妻半路鬧分手。"},
            {"日支_比肩", "日支比肩，夫妻競爭意識強，財星易被分奪，婚姻需各自保持空間。"},
            {"日支_劫財", "日支劫財，財星受破，婚姻財務需謹慎，夫妻宜分開理財。"},
            // ── 時柱 ──
            {"時干_正財", "時上正財運氣通，子女富貴財祿逢。"},
            {"時支_正財", "時支正財逢官印，後代發達有工名。"},
            {"時干_偏財", "時上偏財一位逢，不逢衝破發利名。"},
            {"時支_偏財", "時支若要逢偏財，晚年經營利不薄。"},
            {"時干_正官", "時上正官運氣高，身旺子女必然好。時逢正官一位貴，逢凶化吉死中逃。時干正官逢正財，晚年財生樂逍遙。"},
            {"時支_正官", "時支再把正官現，半凶半吉也享通。"},
            {"時干_七殺", "時上七殺子女強，個性剛烈難教管。晚年需以印化殺，方可子女孝順從。"},
            {"時干_正印", "時上正印晚年安，子女有學有德行。老年靠印多庇護，子孫賢孝福壽全。"},
            {"時干_偏印", "時上偏印子女少，緣份較薄難依靠。晚年宜自修身心，養性修身享清福。"},
            {"時干_食神", "時上食神晚運通，子女富足衣食豐。老年口福享不盡，子孫孝順壽而康。"},
            {"時干_傷官", "時上傷官子女智，聰明伶俐有才情。晚年需防口舌事，子女雖孝多變動。"},
            {"時干_比肩", "時上比肩財難聚，晚年子女各奔馳。財星分散難積存，老年需靠自身力。"},
            {"時干_劫財", "時上劫財晚財薄，財星受奪難積存。子女緣份需珍惜，晚年宜守不宜爭。"},
            {"時支_七殺", "時逢七殺，子女緣較薄，養育過程多操心，宜以印化殺。"},
            {"時支_正印", "時支若要逢正印，晚年子女最賢孝。"},
            {"時支_偏印", "時支若要逢偏印，中年克子，子女緣較薄。"},
            {"時支_食神", "時支再把食神現，晚年子女成富翁。時支若要逢食神，身旺者更佳。"},
            {"時支_傷官", "時支若要逢傷官，克子多把姑娘生，恐怕女多兒子少。"},
            {"時支_比肩", "時支若要逢比肩，子多女少把財爭。"},
            {"時支_劫財", "時支若要劫財見，子女是個財才星。時支若把劫財現，女子不孝敗財星。"},
        ...
        // === Ch.18 流年提要（近十年速查） ===
        private static string LfBuildFlowYearSummaryChapter(
            string dStem,
            ...
            bool hasZiwei, JsonElement palaces)
        {
            ...
            var branchToMonth = new Dictionary<string, string>
            {
                {"寅","2月"},{"卯","3月"},{"辰","4月"},{"巳","5月"},{"午","6月"},{"未","7月"},
                {"申","8月"},{"酉","9月"},{"戌","10月"},{"亥","11月"},{"子","12月"},{"丑","1月"}
            };
            var sixAuspiciousSet = new HashSet<string>
                { "左輔","右弼","文昌","文曲","天魁","天鉞","左","右","昌","曲","魁","鉞" };
            var fourFiendSet = new HashSet<string>
                { "擎羊","陀羅","火星","鈴星","羊","陀","火","鈴" };
            var stemSSEvent = new Dictionary<string, string>
            {
                {"比肩","自我發揮・同業競爭・人脈拓展"},
                {"劫財","偏路活躍・耗財競奪・多動多變"},
                {"食神","才藝口福・子女緣旺・斜槓收入"},
            ...
            sb.AppendLine();
            sb.AppendLine("本章列出近十年流年主事、運勢引動、吉凶月份與紫微提示，供命主年度部署參考。");
            sb.AppendLine();

            for (int year = startYear; year < startYear + 10; year++)
            {
                var (flStem, flBranch) = DyGetYearStemBranch(year);
                int flAge = year - birthYear + 1;

                string flStemSS = LfStemShiShen(flStem, dStem);
                string flBranchMainStem = LfBranchHiddenRatio.TryGetValue(flBranch, out var bh) && bh.Count > 0
                    ? bh[0].stem : "";
                string flBranchSS = !string.IsNullOrEmpty(flBranchMainStem)
                    ? LfStemShiShen(flBranchMainStem, dStem) : "";
                ...
                bool hasAuspicious = false, hasFiend = false;
                var auspStarList  = new List<string>();
                var fiendStarList = new List<string>();
                if (hasZiwei && palaces.ValueKind == JsonValueKind.Array)
                {
                    ziweiPalaceName = KbGetPalaceNameByBranch(palaces, flBranch);
                    if (!string.IsNullOrEmpty(ziweiPalaceName))
                    {
                        var starsSet = KbGetPalaceStarsSet(palaces, ziweiPalaceName);
                        foreach (var s in starsSet)
                        {
                            if (sixAuspiciousSet.Contains(s)) { hasAuspicious = true; auspStarList.Add(s); }
                            if (fourFiendSet.Contains(s))     { hasFiend      = true; fiendStarList.Add(s); }
                        }
                    }
                }

                // 流年天干四化落宮
                string flLuPalace = KbGetSiHuaPalace(flStem, "化祿", palaces);
                ...
                // 運（刑沖合破引動）
                var yunEvents = new List<string>();
                for (int ci = 0; ci < chartBranches.Length; ci++)
                {
                    string cb = chartBranches[ci];
                    string cl = chartBranchLabels[ci];
                    if (cb == flBranch) continue;
                    string pair = flBranch + cb;
                    string pairRev = cb + flBranch;
                    if (LfChong.Contains(pair))
                        yunEvents.Add($"{flBranch}沖{cl}（{cb}）→ {cl}宮位方向震動，防重大異動");
                    else if (LfHe.TryGetValue(flBranch, out var heI) && heI.partner == cb)
                    {
                        bool heGood = heI.elem == yongShenElem || heI.elem == fuYiElem;
                        yunEvents.Add($"{flBranch}與{cl}（{cb}）六合{heI.elem}（{(heGood ? "吉化" : "凶化")}）→ {(heGood ? "順勢有益" : "化忌耗散")}");
                    }
                    else if (LfHai.Contains(pair) || LfHai.Contains(pairRev))
                        yunEvents.Add($"{flBranch}害{cl}（{cb}）→ 暗傷人際，防小人是非");
                    else if (LfPo.Contains(pair) || LfPo.Contains(pairRev))
                        yunEvents.Add($"{flBranch}破{cl}（{cb}）→ 計劃易落空，防耗散");
                }
                foreach (var xg in LfXing)
                {
                    if (!xg.Contains(flBranch)) continue;
                    var cm = xg.Where(b => b != flBranch && chartBranches.Contains(b)).ToList();
                    if (cm.Count > 0)
                        yunEvents.Add($"{flBranch}刑命局{string.Join("・", cm)} → 口舌糾紛・官非留意");
                }
                foreach (var (brs, elem) in LfSanHe)
                {
                    ...
                    if (pts.Count == 2)
                    {
                        bool sg = elem == yongShenElem || elem == fuYiElem;
                        yunEvents.Add($"{flBranch}與命局{string.Join("・", pts)}三合{elem}局（{(sg ? "助吉" : "助凶")}）→ {(sg ? "全年動力大增" : "全年壓力顯著")}");
                    }
                }

                // 吉月 / 凶月
                var goodMonths = new List<string>();
                var badMonths  = new List<string>();
                foreach (var mb in all12Branches)
                {
                    string mbMs   = LfBranchHiddenRatio.TryGetValue(mb, out var mbh) && mbh.Count > 0 ? mbh[0].stem : "";
                    string mbElem = KbStemToElement(mbMs);
                    if      (mbElem == yongShenElem || mbElem == fuYiElem) goodMonths.Add($"{mb}月({branchToMonth[mb]})");
                    else if (mbElem == jiShenElem)                          badMonths.Add($"{mb}月({branchToMonth[mb]})");
                }
                ...
                if (hasZiwei && !string.IsNullOrEmpty(ziweiPalaceName))
                {
                    string auspDesc  = auspStarList.Any()  ? string.Join("・", auspStarList.Distinct().Take(3))  : "";
                    string fiendDesc = fiendStarList.Any() ? string.Join("・", fiendStarList.Distinct().Take(3)) : "";
                    string ziweiBody = (hasAuspicious && hasFiend)
                        ? $"有六吉（{auspDesc}）亦有四煞（{fiendDesc}），吉凶交參，精準擇時"
                        : hasAuspicious ? $"有六吉星（{auspDesc}），吉星護佑，事務吉順"
                        : hasFiend      ? $"有四煞星（{fiendDesc}），煞星衝擊，宜謹慎防守"
                        : "無六吉四煞，宮位平靜，無特殊加持";
                    string luNote = !string.IsNullOrEmpty(flLuPalace) ? $"；{flStem}年化祿飛{flLuPalace}" : "";
                    string jiNote = !string.IsNullOrEmpty(flJiPalace) ? $"；{flStem}年化忌飛{flJiPalace}" : "";
                    sb.AppendLine($"紫微：{flBranch}宮＝{ziweiPalaceName}，{ziweiBody}{luNote}{jiNote}");
                }
                sb.AppendLine();

                // 提要
                string kw = stemEvent.Contains('・') ? stemEvent[..stemEvent.IndexOf('・')] : stemEvent;
                string yunNote = yunEvents.Count > 0 && yunEvents[0].Contains('→')
                    ? yunEvents[0][(yunEvents[0].IndexOf('→') + 1)..].Trim() : "";
                string suggestion = overallClass switch
                {
                    "大吉" => $"天時地利齊備，{flStemSS}（{kw}）為本年最大機遇，{(goodMonths.Count > 0 ? goodMonths[0] + "前後" : "年中")}積極推進，全力把握。",
                    "吉"   => $"整體順勢，{flStemSS}（{kw}）有助力，{(yunNote.Length > 0 ? "注意" + yunNote + "，" : "")}擇吉月精準出手。",
                    "平"   => $"本年平穩推進，{flStemSS}（{kw}）有小機遇，守中求進，{(badMonths.Count > 0 ? badMonths[0] + "前後低調" : "謹慎把握節奏")}。",
                    "小凶" => $"本年壓力偏大，{flStemSS}（{kw}）阻力多，以守為主，{(yunNote.Length > 0 ? yunNote + "，" : "")}暫緩重大決策。",
                    "大凶" => $"壓力集中，{flStemSS}（{kw}）宜暫緩重大行動，深蹲蓄力，保全根基，靜待運轉。",
                    _      => $"平穩推進，{flStemSS}（{kw}），謹慎前行。"
                };
                sb.AppendLine("提要：" + suggestion);
                sb.AppendLine();
            }
                                   ...
                                   string dStem, string dBranch, string hStem, string hBranch)
    {
        ...
        // Ch.4 論青紅（生肖+納音特質）
        // 來源文件（師傳.doc）原本每筆同時列多個生肖，已全部截斷只保留對應年支的第一個生肖。
        // 庚午（午=馬）來源資料開頭即為蛇描述，屬根本性錯誤，清空不顯示。
        var nayinCh4 = new Dictionary<string, string> {
            ["丁丑"] = "湖內之牛。待人和睦，衣祿不虧。早年財不豐富，晚景有餘，骨肉無情，見遲方好；夫婦和順，女命旺夫，持家，賢良之命也。",
            ["丁亥"] = "過山之豬。性溫，手巧聰明，自立家業。兒女有刑傷，見遲方好，一生好善；女命衣祿平穩，無風浪。",
            ["丁卯"] = "為望月之兔，一生手足不停，身心不閑，衣祿可以，可算富貴，女命好靜，一生有福之命。",
            ["丁巳"] = "塘內之蛇。利官有貴，性剛不順，身居長位，事業顯榮；女命美麗，賢達會治家，有財旺夫之命。",
            ["丁未"] = "失群之羊。一生喜怒無常，多口舌，是非不可無。有名利，骨肉生疏，妻遲子晚好；女命財旺助夫，利夫小之命。",
            ["丁酉"] = "樓宿之雞。說話流利，巧言善辯，辦事公正，無私心，衣良平穩。六親無緣，晚景旺相，女命益夫助夫興家。",
            ["丙午"] = "路行之馬。一生清閒，初年有財難聚，無主意，兄弟各自成家，後運旺財發家；女命清正手巧持家。",
            ["丙子"] = "田內之鼠。為人膽大有權，機謀超人，早年平，中年好轉，老年大好。女命主口舌利快。",
            ["丙寅"] = "為山林之虎。其性格不定，心直口快，手足忙碌，不利官。女主賢良，聰明伶俐之命。",
            ["丙戌"] = "白眼之犬。一生多吉利，有招財進寶象徵，自立家業，至老榮華；女命財旺，興家有方。",
            ["丙申"] = "清秀之猴，情高手巧，聰明伶俐，有智謀，遇事多變。和氣春風，功名有分，有賢德之妻，女主貌美色姿。",
            ["丙辰"] = "上天之龍。一生衣食無虧，有名有利，四海春風，愛友喜朋，女命主賢能手巧口巧，旺夫興家之命。",
            ["乙丑"] = "海中之牛，少年運氣不好，有父母重婚之兆。夫婦皆好，兒女不孤，愛好九流藝術。",
            ["乙亥"] = "過往之豬。與人和順，初年多災。父母有刑傷，再拜無妨，夫婦無刑皆老，存心中正，豐足興旺，子息有克破，晚兒方好。",
            ["乙卯"] = "得道之兔。志高氣昂，多計多謀，進事稱心如意，文武皆能。女命主一生福壽無虧之命。",
            ["乙巳"] = "福氣之蛇，有功名之徵兆，伶俐聰明，夫婦命和，做事能遂心願，財豐田足；女命衣良無缺，良婦之命。",
            ["乙未"] = "敬重之羊。容貌端正，少年勤儉，初年平順無大難，晚年聚財巨富，兄弟少力，子息不孤，立家興業之命。",
            ["乙酉"] = "唱午之雞。心直口快，有口無噁心，志氣高，衣食足，福壽雙全，弟兄多，但不得力；女命主興財，平穩之命。",
            ["壬午"] = "軍中之馬。為人勤儉，父母有刑傷，災危可折，早年財物有緊，晚年旺相有餘；女命，主興家也，為賢良之婦。",
            ["壬子"] = "屋上之鼠，為人少學少成，心情急躁，辦事有始無終，幼年有災，兄弟少力，男主女大，女主夫長，可配夫妻美滿。聰明、善良之命。",
            ["壬寅"] = "過林之虎。心直口快，不暗地生非。夫婦，兒女有克，遲方好。初年財不聚，事事難好，晚景豐足之命。",
            ["壬戌"] = "雇家之犬。一生好行善，初年平平，末年興旺。",
            ["壬申"] = "清秀之猴，情高手巧，聰明伶俐，有智謀，遇事多變。和氣春風，功名有分，有賢德之妻，女主貌美色姿。",
            ["壬辰"] = "行雨之龍。為人辛勤勞碌，終日手足不停，早歲運悔，晚景財旺發福；女命為一生操持家業，助夫興家。",
            ["己丑"] = "海中之牛，少年運氣不好，有父母重婚之兆。夫婦皆好，兒女不孤，愛好九流藝術。",
            ["己亥"] = "道院之豬。手巧技藝多，一生衣祿安穩，六親有克，夫婦各順；女命主清閒，老來樂觀之命。",
            ["己卯"] = "為望月之兔，一生手足不停，身心不閑，衣祿可以，可算富貴，女命好靜，一生有福之命。",
            ["己巳"] = "福氣之蛇，有功名之徵兆，伶俐聰明，夫婦命和，做事能遂心願，財豐田足；女命衣良無缺，良婦之命。",
            ["己未"] = "草野之羊。口快善變，衣食自來，前程顯達，有貴人扶，百事華榮，旺相之命。",
            ["己酉"] = "報曉之雞。一生衣食有餘，但六親難靠，早子見婦，聰明好學，百一皆通；女命淫邪多變，一生無災之命。",
            ["庚午"] = "", // 來源資料根本性錯誤：庚午為馬年，但原文開頭即為蛇描述，無法修正，靜默空白
            ["庚子"] = "梁上之鼠。人人尊重，妻主安穩清正，持家有權柄，衣食不虧，通達之命；女命主旺財，並逢凶化吉。",
            ["庚寅"] = "出山之虎。心情急躁，口噁心善，有志氣，握權柄，利官貴。反復多變，衣食不虧；女命榮華，內助興家。",
            ["庚戌"] = "寺院之犬。一生快活，丑年有災，作事機巧，百事如意；女命主聰明伶俐，手巧，能助夫興家旺財之命。",
            ["庚申"] = "食果之猴。一生手足不停，清高利官，但救人不得好報，女命六親冷淡老來興旺之命。",
            ["庚辰"] = "怒性之龍。一生和氣欠佳，勞碌雪霜，不受人欺，利官近貴，名利雙全，衣食有餘之命。",
            ["戊午"] = "殿內之馬。衣祿自然有，五官端正，志氣寬宏，少年有災，骨肉有刑；女命難得姐妹之助，後來興旺自立之命。",
            ["戊子"] = "屋上之鼠，為人少學少成，心情急躁，辦事有始無終，幼年有災，兄弟少力，男主女大，女主夫長，可配夫妻美滿。聰明、善良之命。",
            ["戊寅"] = "為山林之虎。其性格不定，心直口快，手足忙碌，不利官。女主賢良，聰明伶俐之命。",
            ["戊戌"] = "進山之犬。和氣待人，家業自創自立，早年不幸，物財耗散，晚來宜得財，行師藝術，中平之命。",
            ["戊申"] = "獨立之猴。一生急性，作事反復無常，勞碌辛苦，但利官近貴，兒女刑傷，財帛足用；女命賢良懂事，文武皆精，手巧心活，利子女之命。",
            ["戊辰"] = "為清溫之龍，喜氣春風，出入壓群。利官，近貴，骨肉刑傷，兒女無力；女命主溫良賢達，心直口快，必嫁好夫。",
            ["甲午"] = "春中之馬。對人和氣如春風，好交朋友，利官近貴。遇凶化吉，一生無刑。女命能言善語，口尖舌快。",
            ["甲子"] = "屋上之鼠，為人少學少成，心情急躁，辦事有始無終，幼年有災，兄弟少力，男主女大，女主夫長，可配夫妻美滿。聰明、善良之命。",
            ["甲寅"] = "立定之虎。一生利官利貴，家豐財，足衣食，財源繁多，有刑父母，雙親有重拜之災；女主夫大，男主妻長之命。",
            ["甲戌"] = "守門之犬。口快舌尖，用心不用力，有權柄，名聲四海；夫婦相合；女命旺夫生財，興家立業。",
            ["甲申"] = "過樹之猴。一生衣祿不少，性情溫柔。出入皆壓人，初運不利，末運卻佳。夫婦美滿，兒女遲見為好；女命持家，豐物興旺，賢孝之婦。",
            ["甲辰"] = "為清溫之龍，喜氣春風，出入壓群。利官，近貴，骨肉刑傷，兒女無力；女命主溫良賢達，心直口快，必嫁好夫。",
            ["癸丑"] = "海中之牛，少年運氣不好，有父母重婚之兆。夫婦皆好，兒女不孤，愛好九流藝術。",
            ["癸亥"] = "林下之豬。性剛直不順，不易受欺之人；女命能持家興業，家財豐厚，晚年福壽全美之命。",
            ["癸卯"] = "樹木之兔。酒食不欠，福壽有餘，逢凶化吉，一生平安、興隆一世；女命中末運氣欠佳，操持家務一生。",
            ["癸巳"] = "草中之蛇。聰明伶俐，財來不聚，晚年不同前，發財有福；女命賢良，興家助夫。",
            ["癸未"] = "群內之羊。一生有快樂之心，廣行方便，只是救人無恩，反招是非，命中財來不聚，女命賢德持家，晚年榮昌。",
            ["癸酉"] = "樓宿之雞。說話流利，巧言善辯，辦事公正，無私心，衣良平穩。六親無緣，晚景旺相，女命益夫助夫興家。",
            ["辛丑"] = "路途之牛。對人溫和，初年有意外之危。衣食雖有，但進財不存，老來福壽雙至；女命賢良，旺財之命。",
            ["辛亥"] = "圈內之豬。一生不貪閒事，不惹是非，早年財物不足，到老榮華；女命主體壯，能興家立業。",
            ["辛卯"] = "蟾窟之兔。口快，有權。利官近貴身閑，心忙，六親少利，自立自成家業；女命持家，興家旺相。",
            ["辛巳"] = "冬藏之蛇。為人機謀多變，志氣人，一生衣食無虧，主有貴人扶持之徵兆，晚年快樂之命。",
            ["辛未"] = "得祿之羊，一生情性寬大志高，少年不利，夫婦和諧，頭胎見子有刑，女命持家興旺。",
            ["辛酉"] = "籠藏之雞。一生伶俐，精神爽朗，口舌能辯，六親生疏，女命主賢德治家，老來榮華之命。",
        };
        ...
        var nayinCh7 = new Dictionary<string, string> {
            ...
            ["亥_辰"] = "豬人生於辰時，英俊豪爽，樂善好施，心地善良，但愛慕虛榮，深得異性喜愛，少時有財，中年破財，晚年運好。",
            ["亥_酉"] = "豬人生於酉時，本屬大旺，因酉亥相形，反遭破碎意外之事。",
            ["午_丑"] = "馬人生於丑時，男主家庭緣分淡薄，父母難靠，時來運轉，平步青雲，謀事有成；女主待人謙恭有禮，任勞任怨，賢妻良母之典型。",
            ...
            ["卯_戌"] = "卯人生於戌時，紫徽星臨命，雖有王災不幸，終是逢凶化吉。",
            ["卯_亥"] = "卯人生於亥時，白虎星坐命，必有困苦這境，宜慎重為事耳。",
            ...
            ["寅_酉"] = "寅人生於酉時，時逢紫微龍德照命，高照人間福豐隆，平步青雲，凡謀順遂，但應防交友指背，小心破財之災。",
            ...
            ["戌_戌"] = "狗人生於戌時，吉凶極端，主聰敏巧智，具才藝天賦，逢貴人扶持，能功成名就，但性情暴躁，宜養柔德，而免困擾。",
            ...
            ["未_巳"] = "羊人生於巳時，命帶驛馬，心態較不安定，離祖得貴，利在他鄉，須防口舌之災，是非只因多開口，煩惱皆在強出頭。",
            ...
            ["申_戌"] = "猴人生於戌時，文武皆能，富有膽略，但性情急躁，宜平實漸進，必得成功富貴。出外有貴人扶持，重義輕財，中晚年稱心如意。",
        ...
        private static string DyGetLifeStage(int age)
            => age <= 20 ? "teen" : age <= 40 ? "young" : age <= 55 ? "adult" : age <= 70 ? "middle" : "elder";

        private static string DyCrossDescV2(string crossClass, string flStemSS, string flBranchSS)
        {
            string desc = crossClass switch
            {
                "大吉" => "八字用神得力、紫微吉曜同時臨宮，雙重加持，為難得黃金年份。事業、投資、感情皆可大膽佈局，乘勢而上。",
                "吉"   => "八字喜用順暢，紫微宮位有利，整體方向正向。宜主動推進計畫，善用機遇，穩健進取。",
                "平"   => "八字與紫微均屬平穩，無明顯吉凶加持。宜靜守積累、鞏固基礎，蓄勢待發。",
                "小凶" => "八字或紫微之一有壓力，宜低調行事，減少對外衝突，專注鞏固既有成果，防範突發變數。",
                "大凶" => "八字忌神與紫微凶曜同時施壓，內外均有阻礙。此年宜極度低調守成，切勿冒進，靜待轉機，以守為攻。",
                _      => "平穩行事，量力而為，靜待機遇。"
            };
            string ssNote = "";
            if (!string.IsNullOrEmpty(flStemSS)) ssNote = $"流年天干{flStemSS}";
        ...
        private static string DyBuildLifeStageSection(
            string stage, string pattern, string yongShenElem, string jiShenElem,
            string dmElem, double bodyPct, bool hasZiwei, JsonElement palaces,
            int gender, string[] branches, string dStem, string dBranch,
            string yBranch, string mBranch, string hBranch)
        {
            ...
            {
                case "teen":
                    sb.AppendLine("▍ 學業才能方向");
                    string teenCareer = pattern switch
                    {
                        "食神格" or "傷官格" => $"命格【{pattern}】偏向才藝技術，適合理工、設計、音樂、體育等動手實作科系，強記背誦型科目反而吃虧。",
                        "正印格" or "偏印格" => $"命格【{pattern}】適合學術研究，文理科皆有潛力，繼續深造、考取資格證照是天生優勢。",
                        "正官格" or "七殺格" => $"命格【{pattern}】有競爭意識，對考試應試有韌性，適合需要排名競爭的環境，可朝管理或法律方向發展。",
                        _ => $"命格【{pattern}】，天生才能與用神{yongShenElem}相關行業最為契合，喜用大運年份學習效率最佳。"
                    };
                    sb.AppendLine(teenCareer);
                    sb.AppendLine();
                    sb.AppendLine("▍ 貴人助力");
                    sb.AppendLine($"{dStem}日主，貴人多在喜用{yongShenElem}五行旺的大運年份出現，宜主動接觸與此五行相關的師長或前輩。");
                    break;

                case "young":
                    sb.AppendLine("▍ 職業方向");
                    bool suitPublic  = pattern is "正官格" or "正印格";
                    bool suitSelf    = pattern is "傷官格" or "食神格" or "七殺格";
                    bool suitBiz     = pattern is "偏財格" or "正財格";
                    string careerDir = suitPublic && !suitSelf
                        ? $"命格【{pattern}】天生適合公家體制或大型機構，公務員、國企、教育、醫療等穩定職場是發揮舞台。自行創業阻力較大，宜在制度內晉升。"
                        : suitSelf
                        ? $"命格【{pattern}】天生適合技術自立、創業開店或自雇型工作，長期在大機構上班容易感到束縛，確立核心專業技術是關鍵。"
                        : suitBiz
                        ? $"命格【{pattern}】對商機財路嗅覺靈敏，業務、貿易、商業運作均有發揮空間，私人企業或自行創業皆可。"
                        : $"命格【{pattern}】，以用神{yongShenElem}相關行業為主要方向，{LfCareerDesc(pattern)}。";
                    sb.AppendLine(careerDir);
                    sb.AppendLine($"適合行業：{LfElemCareer(yongShenElem)}");
                    sb.AppendLine();

                    sb.AppendLine("▍ 國內/國外發展");
                    sb.AppendLine(LfHaiWaiAnalysis(yBranch, mBranch, dBranch, hBranch, yongShenElem, jiShenElem, dmElem, hasZiwei, palaces));
                    sb.AppendLine();

                    sb.AppendLine("▍ 感情與婚姻");
                    sb.AppendLine(LfMarriageDesc(0, dBranch, dStem, dmElem, gender, branches));
                    // 婚姻早晚：夫妻星在年/月柱偏早，時柱偏晚
                    string spouseElemYoung = gender == 1 ? LfElemOvercome.GetValueOrDefault(dmElem, "") : LfElemOvercomeBy.GetValueOrDefault(dmElem, "");
                    string earlyLate = (LfBranchElem.GetValueOrDefault(yBranch, "") == spouseElemYoung || LfBranchElem.GetValueOrDefault(mBranch, "") == spouseElemYoung)
                        ? "夫妻星現於年月柱，感情緣份出現較早，宜把握20-30歲間的緣份。"
                        : LfBranchElem.GetValueOrDefault(hBranch, "") == spouseElemYoung
                        ? "夫妻星藏於時柱，感情正緣多在30歲後方顯，宜耐心等待，勿因心急而委就。"
                        : "感情緣份平穩，順其自然即可，喜用大運年份桃花機遇最旺。";
                    sb.AppendLine(earlyLate);
                    sb.AppendLine();

                    sb.AppendLine("▍ 財富起步與置產");
                    string wealthYoung = pattern switch
                    {
                        "偏財格" => "偏財格財路廣但起伏大，業務、投資、創業型收入是主軸，正財薪資反而不是強項，善用偏財運才能發揮命格優勢。",
                        "正財格" => "正財格財富靠穩健累積，固定薪資收入為主，不宜冒進投機，每月固定儲蓄勝過一時暴富。",
                        "食神格" or "傷官格" => "食傷格以技術換取財富，一技在身財自來，30歲前確立核心技能，之後財運自然跟進。",
                        _ => $"財運與大運走向密切相關，用神{yongShenElem}旺年是財富積累黃金期，建議此類年份積極進取。"
                    };
                    sb.AppendLine(wealthYoung);
                    sb.AppendLine($"置產時機：喜用{yongShenElem}旺的大運流年，且流年不逢日支{dBranch}沖，田宅宮有吉星化祿的年份為最佳進場時機。");
                    sb.AppendLine();

                    if (!LfShouldSkipPalace("子女宮", 20))
                    {
                        sb.AppendLine("▍ 子女緣份");
                        string childStars = hasZiwei ? KbGetPalaceStars(palaces, "子女宮") : "";
                        string childPalDesc = string.IsNullOrEmpty(childStars) ? "子女宮空宮，子女緣較淡，或晚得子女為多。" : $"子女宮主星：{childStars}，可從星曜性質判斷子女緣深淺與個性特質。";
                        string baziChild = pattern switch
                        {
                            "食神格" => "食神格子女緣深，且子女多聰明才藝。",
                            "傷官格" => "傷官格子女個性獨立，教育上宜給予空間，勿過度干涉。",
                            _ => gender == 1 ? "男命時柱代表子女，時干時支喜用則子女緣佳、成就較高。" : "女命食傷代表子女，食傷旺則子女緣深、易得子。"
                        };
                        sb.AppendLine(childPalDesc);
                        sb.AppendLine(baziChild);
                    }
                    break;

                case "adult":
                    sb.AppendLine("▍ 事業走向（突破或守成）");
                    bool canBreak = pattern is "七殺格" or "偏財格" or "傷官格";
                    string adultCareer = canBreak
                        ? $"命格【{pattern}】在40-55歲仍有突破機會，喜用大運流年可考慮轉型、升遷或擴大版圖，但需八字與紫微同時有利，忌單憑衝勁盲目冒進。"
                        : $"命格【{pattern}】此階段以守成鞏固為主，宜深耕既有優勢，穩固職位與財庫，不宜輕易轉換跑道，重大投資決策務必謹慎評估。";
                    sb.AppendLine(adultCareer);
                    sb.AppendLine();
                    sb.AppendLine("▍ 財富守護與置產時機");
                    sb.AppendLine($"40-55歲是財富累積關鍵期，用神{yongShenElem}旺年積極理財投資，忌神{jiShenElem}旺年嚴格守財，避免作保擔保或大額投機。置產宜在此階段完成，越晚財力越分散。");
                    sb.AppendLine();
                    if (!LfShouldSkipPalace("夫妻宮", 45))
                    {
                        sb.AppendLine("▍ 婚姻穩定度");
                        sb.AppendLine($"中年期婚姻壓力多來自事業財務的交迫，日支{dBranch}逢沖的流年婚姻最易出現摩擦，宜多溝通、勿悶在心裡，防中年危機。");
                        sb.AppendLine();
                    }
                    sb.AppendLine("▍ 子女成就");
                    sb.AppendLine("此階段子女進入求學就業期，子女宮有吉星化祿的流年，子女成就最為顯著，宜適度支持而非過度干預。");
                    break;

                case "middle":
                    sb.AppendLine("▍ 事業退場時機");
                    sb.AppendLine($"命格【{pattern}】，55-70歲宜逐步淡出第一線，以顧問指導型角色延續影響力。官祿宮有化忌的大限，是事業自然收手的訊號，強行硬撐往往得不償失。");
                    sb.AppendLine();
                    sb.AppendLine("▍ 財庫守護");
                    sb.AppendLine($"防詐騙、防擔保借貸是此階段最重要的財務守則。忌神{jiShenElem}旺年財庫最易受損，大額金融操作務必謹慎，田宅宮有化忌的年份不宜買賣房產。");
                    sb.AppendLine();
                    sb.AppendLine("▍ 子女依靠評估");
                    string midChildStars = hasZiwei ? KbGetPalaceStars(palaces, "子女宮") : "";
                    sb.AppendLine(string.IsNullOrEmpty(midChildStars)
                        ? "子女宮空宮，晚年宜培養與子女的感情聯繫，勿過度依賴子女為唯一支柱，財務上保持獨立更為安心。"
                        : $"子女宮主星{midChildStars}，大限化祿年份與子女關係最為親密，宜珍惜此段時光。");
                    break;

                case "elder":
                    sb.AppendLine("▍ 健康與壽元");
                    sb.AppendLine($"70歲後忌神{jiShenElem}對應臟腑需重點護理，每年定期健康檢查是最重要的行動，養生重於一切。");
                    sb.AppendLine();
                    sb.AppendLine("▍ 子孫緣與晚年陪伴");
                    sb.AppendLine("田宅宮、子女宮有吉星的大限年份，晚年生活最為安樂充實，家庭氣氛和諧，子孫帶來的喜悅是最好的補藥。");
                    sb.AppendLine();
                    sb.AppendLine("▍ 財產傳承安排");
                    sb.AppendLine("財產安排宜在70-75歲間完成，田宅宮有化忌的大限後期易有財產糾紛，建議提早立好遺囑或信託，避免子孫為財失和。");
                    break;
            }
            return sb.ToString();
        }

        private static string DyBuildKeyYearsSection(
        ...
        private static string DyBuildReport_V2(
            string yStem, string yBranch, string mStem, string mBranch,
            string dStem, string dBranch, string hStem, string hBranch,
            string yStemSS, string mStemSS, string hStemSS,
            string yBranchSS, string mBranchSS, string dBranchSS, string hBranchSS,
            ...
            int gender, int birthYear, int years, string[] branches, string dStemRef)
        {
            ...
            sb.AppendLine($"用神：{yongShenElem}  忌神：{jiShenElem}");
            // 命格先天基調（一句話定性）
            string baziTone = (bodyPct >= 60, pattern) switch
            {
                (true, "七殺格") => "此命先天氣魄強，大起大落型，越挫越勇，適合在競爭激烈的環境中發光。",
                (true, "傷官格") => "此命才華橫溢，個性鮮明，不甘平凡，最怕被規矩束縛，找到發揮舞台便能一鳴驚人。",
                (true, _)        => "此命日主強旺，自立能力強，行事有主見，喜用得力時命運主動掌握在自己手中。",
                (false, "正印格") => "此命貴人緣深，長輩師長助力多，借助外力往往比單打獨鬥更有效率。",
                (false, "偏印格") => "此命思維獨特，擅長鑽研偏門，在特殊專業領域往往有意想不到的成就。",
                (false, _)       => "此命日主偏弱，走扶身大運時運勢最佳，善用人脈貴人之力是人生關鍵策略。"
            };
            sb.AppendLine(baziTone);
            ...
            if (!string.IsNullOrEmpty(curLC.stem))
            {
                ...
                string lcElem   = KbStemToElement(curLC.stem);
                bool   lcGood   = lcElem == yongShenElem || lcElem == fuYiElem;
                string lcColor  = lcGood ? "順境" : lcElem == jiShenElem ? "逆境" : "平穩期";
                sb.AppendLine($"當前大運：{curLC.stem}{curLC.branch}（天干{curLCSS}·地支{curLCBSS}），{curLC.startAge}-{curLC.endAge} 歲，整體屬{lcColor}。");
            }
            sb.AppendLine();
            ...
            string[] dyTiaoHouList = LfTiaoHou.TryGetValue(dStemRef, out var dyTh1) && dyTh1.TryGetValue(mBranch, out var dyTh2) ? dyTh2 : Array.Empty<string>();
            ...
            var coveredLucks   = luckCycles.Where(lc => annualDetails.Any(a => a.age >= lc.startAge && a.age < lc.endAge)).ToList();
            ...
            foreach (var lc in coveredLucks)
            {
                ...
                string lcLevel = LfLuckLevel(lcScore);
                // 天干喜忌判定
                string lcStemElem = KbStemToElement(lc.stem);
                bool lcStemGood   = lcStemElem == yongShenElem || lcStemElem == fuYiElem;
                bool lcStemBad    = lcStemElem == jiShenElem;
                string stemTrend  = lcStemGood ? "屬喜用" : lcStemBad ? "屬忌神" : "屬中性";
                // 整體大運基調（不顯示分數）
                string lcBaseTone = lcLevel switch
                {
                    "大吉" or "吉" => $"整體屬順境，適合積極推進人生大計。",
                    "平"           => $"整體屬平穩期，宜鞏固基礎，蓄勢待發。",
                    _              => $"整體壓力偏大，以守成低調為主旋律。"
                };
                sb.AppendLine($"▍ {lc.startAge}-{lc.endAge} 歲  大運：{lc.stem}{lc.branch}（{lcSS}·{lcBSS}）");
                sb.AppendLine($"  {lcBaseTone}");
                sb.AppendLine();
                // 天干事項
                ...
                if (!string.IsNullOrEmpty(lcStemEventDesc))
                    sb.AppendLine($"  【天干{lc.stem}（{lcSS}·{stemTrend}）】{lcStemEventDesc}");
                // 天干合化
                if (LfTianGanHeMap.TryGetValue(lc.stem, out var lcTgHe) && dyChartStems.Contains(lcTgHe.stem))
                    sb.AppendLine($"  大運天干{lc.stem}被命局{lcTgHe.stem}合化，{(lcStemGood ? "喜用力量稍受牽制，效力略減。" : "忌神被合化，凶意稍緩。")}");
                // 地支事項
                ...
                if (!string.IsNullOrEmpty(palaceEvents))
                    sb.AppendLine($"  【地支{lc.branch}（{lcBSS}）】{palaceEvents}");
                // 五大模組
                ...
                if (hasZiwei)
                {
                    int lcAStart = Math.Max(lc.startAge, minAnalysisAge);
                    int lcAEnd   = Math.Min(lc.endAge, maxAnalysisAge);
                    var warnPals = DyGetOverlappingDecadePalaces(palaces, lcAStart, lcAEnd);
                    var keyPalW  = new HashSet<string> { "命宮", "財帛宮", "官祿宮", "夫妻宮", "田宅宮" };
                    foreach (var (wPal, wStem, wPs, wPe) in warnPals)
                    {
                        if (string.IsNullOrEmpty(wStem)) continue;
                        string dyJiPal = KbGetSiHuaPalace(wStem, "化忌", palaces);
                        if (!string.IsNullOrEmpty(dyJiPal) && keyPalW.Contains(dyJiPal) && !LfShouldSkipPalace(dyJiPal, lc.startAge))
                        {
                            ...
                            sb.AppendLine($"  【紫微大限提醒】此段大限（{wPs}-{wPe}歲）宮干{wStem}化忌入{dyJiPal}：{jiNote}。");
                        }
                    }
                }
                // 紫微大限宮位（精簡版：只顯示命宮主星 + 四化，不展開12宮）
                if (hasZiwei)
                {
                    int lcAStart2  = Math.Max(lc.startAge, minAnalysisAge);
                    int lcAEnd2    = Math.Min(lc.endAge, maxAnalysisAge);
                    var overPals   = DyGetOverlappingDecadePalaces(palaces, lcAStart2, lcAEnd2);
                    foreach (var (lcDecPal, lcDecStem, pStart, pEnd) in overPals)
                    {
                        int overlapYrs = Math.Min(lc.endAge, pEnd) - Math.Max(lc.startAge, pStart) + 1;
                        if (overlapYrs < 2) continue;
                        string decLabel = pStart == pEnd ? $"{pStart}歲" : $"{pStart}-{pEnd}歲";
                        string palStars = KbGetPalaceStars(palaces, lcDecPal);
                        sb.AppendLine($"  【紫微大限（{decLabel}）{lcDecPal}】{(string.IsNullOrEmpty(palStars) ? "空宮" : palStars)}");
                        // 宮干四化（精簡）
                        if (!string.IsNullOrEmpty(lcDecStem) && YearStemSiHuaMap.TryGetValue(lcDecStem, out var lcSiHua2))
                        {
                            string luPal = KbGetSiHuaPalace(lcDecStem, "化祿", palaces);
                            string jiPal = KbGetSiHuaPalace(lcDecStem, "化忌", palaces);
                            if (!string.IsNullOrEmpty(luPal)) sb.AppendLine($"    宮干{lcDecStem}化祿（{lcSiHua2.lu}）入{luPal}，{luPal}方向有財祿助力。");
                            if (!string.IsNullOrEmpty(jiPal) && !LfShouldSkipPalace(jiPal, pStart))
                                sb.AppendLine($"    宮干{lcDecStem}化忌（{lcSiHua2.ji}）入{jiPal}，此大限{jiPal}需特別謹慎。");
                        }
                    }
                }
                // 交叉結論（分項論斷）
            ...
            sb.AppendLine(LfCheGuanAnalysis(yBranch, mBranch, dBranch, hBranch, jiShenElem, dmElem));
            {
                string guanShaElem = LfElemOvercomeBy.GetValueOrDefault(dmElem, "");
                var siYiMa = new HashSet<string> { "寅", "申", "巳", "亥" };
                var riskBranches = new[] { yBranch, mBranch, dBranch, hBranch }
                    .Where(b => siYiMa.Contains(b) && LfBranchElem.GetValueOrDefault(b, "") == guanShaElem).ToList();
                if (riskBranches.Count > 0)
                {
                    var cheGuanYears = annualDetails.Where(a => riskBranches.Any(rb =>
            ...
            sb.AppendLine();
            sb.AppendLine("▍ 天乙貴人方向");
            var tianYiMapV2 = new Dictionary<string, string>
            {
                {"甲","丑未"},{"戊","丑未"},{"庚","丑未"},{"乙","子申"},{"己","子申"},
                {"丙","亥酉"},{"丁","亥酉"},{"壬","卯巳"},{"癸","卯巳"},{"辛","午寅"}
            };
            string tianYiBrV2 = tianYiMapV2.GetValueOrDefault(dStem, "");
            ...
            var allBadV2  = annualDetails.Where(a => a.crossClass is "大凶" or "小凶").ToList();
            double goodRatio = annualDetails.Count > 0 ? (double)allGoodV2.Count / annualDetails.Count : 0;
            string overallTone = goodRatio >= 0.5
                ? $"分析期間整體屬順境偏多，此段人生是積極布局的好時機，吉年全力衝刺，凶年稍作收守即可。"
                : goodRatio >= 0.3
                ? $"分析期間吉凶各半，需精準選擇時機，黃金年份果斷出手，壓力年份低調蓄勢，一進一退之間決定成敗。"
                : $"分析期間整體壓力偏大，此段以守住既有成果為優先，等待下一個好運週期再大舉展開。";
            sb.AppendLine($"▍ 整體策略");
            sb.AppendLine(overallTone);
            sb.AppendLine();
            ...
            sb.AppendLine();
            if (allGoodV2.Count > 0)
            {
                sb.AppendLine($"  黃金年份（{string.Join("、", allGoodV2.Select(y => $"{y.year}年"))}）宜：");
                string goodAction = stage switch
                {
                ...
                sb.AppendLine($"    {goodAction}");
            }
            if (allBadV2.Count > 0)
            {
                sb.AppendLine($"  謹慎年份（{string.Join("、", allBadV2.Select(y => $"{y.year}年"))}）宜：");
                string badAction = stage switch
                {
            ...
            string dStem, string dBranch)
        {
            ...
            foreach (var d in annualDetails)
            {
                ...
                if (isGoodYear)
                {
                    ...
                    if (stage != "elder")
                    {
                        ...
                        string loveGoodV3 = loveStarV3G
                            ...
                            : d.flStemSS switch
                            {
                                "食神"   => "食神流年家庭溫馨，子女緣旺，夫妻感情因生活品質提升而加分",
                                "傷官"   => "才華展現帶動吸引力提升，感情因個人魅力增強而更豐富多彩",
                                "正印"   => "長輩認可帶來家庭凝聚，婚姻在穩定中提升品質，宜加強親情聯繫",
                                "偏印"   => "靜心進修帶來自我成長，夫妻感情因彼此成熟而更穩固",
                                "比肩"   => "社交互動帶來新鮮感，夫妻可安排共同活動，增進默契與情感深度",
                                "劫財"   => "活躍的外在環境帶動感情動力，適時表達愛意，感情升溫",
                                "正官"   => "責任感與形象加分，感情在穩健基礎上品質提升，伴侶欣賞你的可靠",
                                "七殺"   => "衝勁帶來魅力，感情波動較大，需主動溝通，防誤解累積影響感情",
                                _        => stage switch
                                {
                    ...
                    string wealthGoodV3 = (d.flStemSS is "正財" or "偏財")
                        ...
                        : d.flStemSS switch
                        {
                            "正官"   => "官職晉升帶動薪資增長，可規劃中長期置產或增加投資比例",
                            "七殺"   => "競爭勝出後財路寬廣，可擴大理財規模，評估新投資渠道",
                            "傷官"   => "技術或創業帶動額外收入，開源同步建立理財計畫最有利",
                            "食神"   => "多元生活帶動被動收入機會，評估分散投資或增加財庫厚度",
                            "正印"   => "貴人引薦間接提升收入，可進行系統性理財規劃或資產優化",
                            "偏印"   => "偏門收入或被動收入有機會，長期投資、不動產可納入規劃",
                            "比肩"   => "合作分潤或聯合投資機會多，多方財路同開，謹慎評估合夥條件",
                            "劫財"   => "偏財機遇多，可小額試水新投資渠道，同時保留穩健底倉",
                            _        => stage switch
                            {
                                "teen"   => "獎學金或兼職收入機會增加",
                ...
                else if (isBadYear)
                {
                    ...
                    {
                        "正官" => "官職束縛感強，上司管控嚴苛，守分耐心低調，防小人是非打壓",
                        "七殺" => "衝突意外偏多，外部壓力強大，守紀律不衝動，防意外傷害與突發官非",
                        "傷官" => "口舌是非最重，易與上司對立，謹言慎行，暫緩轉職創業",
                        "劫財" => "競爭耗財耗力，合夥易生糾紛，宜獨立作業，謹慎選合作對象",
                        "比肩" => "同業競爭激烈，人際摩擦增多，守住本分，防被分薄資源",
                        _ => "事業推進阻力偏大，守成為主，暫緩重大職業決策"
                    };
                    ...
                    if (stage != "elder")
                    {
                        ...
                        string loveBadV3 = loveBadStarV3
                            ...
                            : d.flStemSS switch
                            {
                                "正官"         => "規範壓力使關係緊繃，避免過度控制或批評伴侶，保持彈性與包容",
                                "七殺"         => "外部衝突帶來情緒波動，易遷怒伴侶，刻意放慢步調，給感情留空間",
                                "傷官"         => "言語刻薄風險高，管住嘴是護感情的關鍵，避免逞一時口舌之快",
                                "劫財" or "比肩" => "社交複雜帶來人際摩擦，防感情因外部干擾受損，守護二人世界",
                                "偏印"         => "情緒易內斂不表達，主動溝通是關鍵，防感情漸行漸遠",
                                _              => stage switch
                                {
                    ...
                    string wealthBadV3 = (d.flStemSS is "正財" or "偏財")
                        ...
                        : d.flStemSS switch
                        {
                            "正官" => "官職壓力帶動財務緊縮，職場變動可能衝擊收入，嚴控開支為主",
                            "七殺" => "衝突意外易帶來意外支出，急剎車守財，防衝動財務決策",
                            "劫財" or "比肩" => "競爭耗財，同輩分食，謹防合夥是非或借貸糾紛",
                            "傷官" => "衝動消費或輕率投資易失誤，保守理財，等待更好時機",
                            "偏印" or "正印" => "計畫易受干擾阻礙，守舊策略，暫緩新投資規劃",
                            _ => "財務宜全面收緊開銷，大型投資計畫暫緩，防財務陷阱與意外支出"
                        };
        ...
        public async Task<IActionResult> GetLiunianAnalysis([FromQuery] int year = 0)
        {
            ...
            try
            {
                ...
                // 小限命宮技法（歲星臨命圖）預計算，傳入 LnBuildReport 做 3.1c 輸出
                string lnMingGongChartText = "";
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(lnMgBranch))
                    {
                        ...
                        string lnFlBranchMg = brStdLn[lnYearBrIdx % 12];
                        string lnFlStemMg   = stems60Ln[lnYearIdx % 10];
                        int lnYearId = Array.IndexOf(brStdLn, lnFlBranchMg) + 1;
                        ...
                        lnMgSb.AppendLine($"（{year}年 {lnFlStemMg}{lnFlBranchMg}）命宮在{lnMgBranch}（{lnMgStarName}），小限臨命宮");
                        lnMgSb.AppendLine();
                        ...
                        lnMingGongChartText = lnMgSb.ToString().Trim();
                    }
                }
        ...
        {
            ["甲"] = new() { ["亥"]="長生",["子"]="沐浴",["丑"]="冠帶",["寅"]="臨官",["卯"]="帝旺",["辰"]="衰",["巳"]="病",["午"]="死",["未"]="墓",["申"]="絕",["酉"]="胎",["戌"]="養" },
            ["乙"] = new() { ["午"]="長生",["巳"]="沐浴",["辰"]="冠帶",["卯"]="臨官",["寅"]="帝旺",["丑"]="衰",["子"]="病",["亥"]="死",["戌"]="墓",["酉"]="絕",["申"]="胎",["未"]="養" },
            ["丙"] = new() { ["寅"]="長生",["卯"]="沐浴",["辰"]="冠帶",["巳"]="臨官",["午"]="帝旺",["未"]="衰",["申"]="病",["酉"]="死",["戌"]="墓",["亥"]="絕",["子"]="胎",["丑"]="養" },
            ["丁"] = new() { ["酉"]="長生",["申"]="沐浴",["未"]="冠帶",["午"]="臨官",["巳"]="帝旺",["辰"]="衰",["卯"]="病",["寅"]="死",["丑"]="墓",["子"]="絕",["亥"]="胎",["戌"]="養" },
            ["戊"] = new() { ["寅"]="長生",["卯"]="沐浴",["辰"]="冠帶",["巳"]="臨官",["午"]="帝旺",["未"]="衰",["申"]="病",["酉"]="死",["戌"]="墓",["亥"]="絕",["子"]="胎",["丑"]="養" },
            ["己"] = new() { ["酉"]="長生",["申"]="沐浴",["未"]="冠帶",["午"]="臨官",["巳"]="帝旺",["辰"]="衰",["卯"]="病",["寅"]="死",["丑"]="墓",["子"]="絕",["亥"]="胎",["戌"]="養" },
            ["庚"] = new() { ["巳"]="長生",["午"]="沐浴",["未"]="冠帶",["申"]="臨官",["酉"]="帝旺",["戌"]="衰",["亥"]="病",["子"]="死",["丑"]="墓",["寅"]="絕",["卯"]="胎",["辰"]="養" },
            ["辛"] = new() { ["子"]="長生",["亥"]="沐浴",["戌"]="冠帶",["酉"]="臨官",["申"]="帝旺",["未"]="衰",["午"]="病",["巳"]="死",["辰"]="墓",["卯"]="絕",["寅"]="胎",["丑"]="養" },
            ["壬"] = new() { ["申"]="長生",["酉"]="沐浴",["戌"]="冠帶",["亥"]="臨官",["子"]="帝旺",["丑"]="衰",["寅"]="病",["卯"]="死",["辰"]="墓",["巳"]="絕",["午"]="胎",["未"]="養" },
            ["癸"] = new() { ["卯"]="長生",["寅"]="沐浴",["丑"]="冠帶",["子"]="臨官",["亥"]="帝旺",["戌"]="衰",["酉"]="病",["申"]="死",["未"]="墓",["午"]="絕",["巳"]="胎",["辰"]="養" },
        };
        ...
        // 流年十神具體人事場域論斷庫（喜用/忌神 x 男/女共四版本）
        private static readonly Dictionary<string, (string MaleGood, string MaleBad, string FemaleGood, string FemaleBad)> LnShiShenXiangDict = new()
        {
            ["正官"] = (
                "正官逢喜用，今年官運亨通，領導、上司帶來正向機緣；升遷表彰、資格認定都有機會推進；合約文書順利，貴人來自名分地位較高之人。重要場所多在政府機關、學校或正式機構。",
                "正官逢忌神，今年官非壓力偏大，管束限制增多；合約法律事務需格外謹慎，官司文書風險上升；上司長輩關係易起摩擦，行事宜低調，身體留意慢性狀況。",
                "正官逢喜用，今年夫緣順暢，感情婚姻有正向進展；職場領導帶來提攜機緣，資格名分確立在今年有所推進；重要場所多在政府機關或正式機構。",
                "正官逢忌神，今年感情婚姻關係易有摩擦，夫緣複雜；職場管束增多，官非文書風險偏高；行事宜低調謹慎，慢性健康需留意。"
            ),
            ["七殺"] = (
                "七殺逢喜用，今年競爭轉化為強大動力，適合在高挑戰環境中脫穎而出；行動力強，勇於開拓，可爭取領導或獨當一面的機會。",
                "七殺逢忌神，今年競爭壓力極大，官非意外傷害的風險偏高；強勢對手或主管的阻礙增多，行事宜低調謹慎，身體特別留意外傷或急症。",
                "七殺逢喜用，今年男性緣分活絡，感情機緣增多；競爭轉化為動力，適合主動出擊突破困境。",
                "七殺逢忌神，今年男性緣分複雜，感情關係需謹慎；官司糾紛意外事件是需防範的象；競爭壓力偏大，身體留意外傷或急症。"
            ),
            ["偏官"] = (
                "偏官逢喜用，今年競爭轉化為強大動力，適合在高挑戰環境中脫穎而出；行動力強，勇於開拓，可爭取獨當一面的機會。",
                "偏官逢忌神，今年競爭壓力極大，官非意外傷害的風險偏高；強勢對手或主管的阻礙增多，行事宜低調謹慎，身體特別留意外傷或急症。",
                "偏官逢喜用，今年男性緣分活絡，感情機緣增多；競爭轉化為動力，適合主動出擊突破困境。",
                "偏官逢忌神，今年男性緣分複雜，感情關係需謹慎；官司糾紛意外事件是需防範的象；競爭壓力偏大，身體留意外傷或急症。"
            ),
            ["正財"] = (
                "正財逢喜用，今年財運暢旺，薪資進帳、固定收益或置產購屋機會明顯；另一半緣分加重，感情關係正向進展；是理財置產的好時機。",
                "正財逢忌神，今年財務壓力偏大，薪資收入易有阻礙；配偶關係需多花心思維護；財務宜保守，避免大額支出或借貸。",
                "正財逢喜用，今年財運暢旺，薪資進帳、固定收益在今年有所增進；身體也在此象中得到滋養，整體狀況較佳。",
                "正財逢忌神，今年財務壓力偏大，薪資收入易有阻礙；身體需多加愛護照顧；財務宜保守，避免大額支出。"
            ),
            ["偏財"] = (
                "偏財逢喜用，今年偏財運旺，生意往來意外之財有機緣；父親相關事務今年有好消息；感情方面異性緣佳但宜有所節制。",
                "偏財逢忌神，今年財務流動易散；父親相關事務需多留意；感情複雜緣分帶來麻煩，財務宜守。",
                "偏財逢喜用，今年偏財運旺，生意往來或意外之財有機緣；父親相關事務今年有好消息；財務靈活佈局有收穫。",
                "偏財逢忌神，今年財務流動易散；父親相關事務需多留意；財務宜守，避免過度投機。"
            ),
            ["正印"] = (
                "正印逢喜用，今年貴人庇蔭旺盛，母親或師長帶來支援；求學進修、資格考取有好結果；文書事務順利，有搬遷或精神沉澱的好機緣。",
                "正印逢忌神，今年庇蔭受阻，才藝食傷被壓制；過度依賴長輩反而帶來束縛；文書事務宜謹慎，需培養主動積極的力量。",
                "正印逢喜用，今年貴人庇蔭旺盛，母親或師長帶來支援；求學進修、資格考取有好結果；文書事務順利，搬遷或精神沉澱有好機緣。",
                "正印逢忌神，今年庇蔭受阻，才藝食傷被壓制；文書事務宜謹慎；過度依賴反而帶來束縛，需培養獨立行動力。"
            ),
            ["偏印"] = (
                "偏印逢喜用，今年適合深度學習、宗教靈修或靜態研究；特殊知識與技能有所精進；宜靜不宜動，沉澱思考累積智慧。",
                "偏印逢忌神，今年事情容易拖延孤立，才藝食傷受剋制；飲食和消化需特別留意；不宜輕易擴張，守成為上。",
                "偏印逢喜用，今年適合深度學習、宗教靈修或靜態研究；特殊知識有所精進；宜靜不宜動，適合沉澱累積。",
                "偏印逢忌神，今年事情容易拖延孤立，子女或晚輩事務有小波折；飲食需注意；不宜輕易擴張，守成為上。"
            ),
            ["食神"] = (
                "食神逢喜用，今年口福財緣俱佳，才藝展現機會多；旅遊休閒生意策劃都有好結果；晚輩關係融洽，心境愉快帶動財運。",
                "食神逢忌神，今年雖有才能卻難以充分發揮，財官受到制約；口才可用但需謹慎，避免言多語失影響財務。",
                "食神逢喜用，今年口福財緣俱佳，子女有喜訊；才藝展現機會多，旅遊休閒充實；心境愉快帶動財運。",
                "食神逢忌神，今年才能難以充分發揮；子女事務有小挑戰；口才可用但需謹慎，避免言多語失。"
            ),
            ["傷官"] = (
                "傷官逢喜用，今年口才才藝爆發力強，創意突破是最大的利器；旅遊、運動、開拓新局在今年活絡；適合創意、技術或法律等高才藝領域。",
                "傷官逢忌神，今年官非口舌是非的風險最高，言語宜格外謹慎；才能反而帶來麻煩，需低調行事，避免鋒芒外露。",
                "傷官逢喜用，今年口才才藝爆發力強，創意突破是最大的利器；子女方面有積極動態；旅遊、運動、開拓新局在今年活絡。",
                "傷官逢忌神，今年官非口舌是非的風險最高，言語宜格外謹慎；子女相關事務今年有波折；才能反而帶來麻煩，低調行事為先。"
            ),
            ["比肩"] = (
                "比肩逢喜用，今年兄弟同儕帶來助力，合夥機緣好；平輩人際拓展積極，同業競爭也能轉化為合作動力。",
                "比肩逢忌神，今年財務受同輩競爭侵蝕，合夥糾紛或朋友借貸風險偏高；需防損友，財務宜各立門戶，謹慎往來。",
                "比肩逢喜用，今年兄弟同儕帶來助力，合夥機緣好；平輩人際拓展積極，協作機會多。",
                "比肩逢忌神，今年財務受同輩競爭侵蝕，合夥糾紛或朋友借貸風險偏高；需防損友，謹慎財務往來。"
            ),
            ["劫財"] = (
                "劫財逢喜用，今年競爭動力強，同儕互相激勵；行動力偏強，適合積極競爭爭取資源（謹慎財務往來仍為上）。",
                "劫財逢忌神，今年奪財之象最重，財務損失合夥糾紛風險偏高；需鞏固既有資產，嚴格管控財務出入，避免輕易擴張。",
                "劫財逢喜用，今年競爭動力強，同儕互相激勵；行動力偏強，適合積極競爭爭取資源（謹慎財務往來仍為上）。",
                "劫財逢忌神，今年奪財之象最重，財務損失合夥糾紛風險偏高；需鞏固既有資產，嚴格管控財務出入，避免輕易擴張。"
            ),
        };
            ...
            string mingGongChartText = "")
        {
            ...
            // 流年十神具體人事場域論斷
            {
                ...
                bool stemIsGood = flStemElem == yongShenElem || flStemElem == fuYiElem;
                bool stemIsBad  = flStemElem == jiShenElem;
                var xiangSb = new StringBuilder();

                // [A] 天干：以十神 + 喜忌論
                if (!string.IsNullOrEmpty(flStemSS) && LnShiShenXiangDict.TryGetValue(flStemSS, out var stemXiang))
                {
                    string desc = (isMale, stemIsBad) switch {
                        (true,  true)  => stemXiang.MaleBad,
                        (true,  false) => stemXiang.MaleGood,
                        (false, true)  => stemXiang.FemaleBad,
                        (false, false) => stemXiang.FemaleGood,
                    };
                    string goodBadLabel = stemIsGood ? "喜用" : stemIsBad ? "忌神" : "中性";
                    xiangSb.AppendLine($"  天干{flStem}（{flStemSS}·{goodBadLabel}）：");
                    xiangSb.AppendLine($"  {desc}");
                    xiangSb.AppendLine();
                }

                // [B] 地支：天干十二長生強弱 + 地支自身象 + 刑沖合破
                {
                    var brLines = new List<string>();

                    // B1. 天干在此地支的十二長生
                    if (LnStemLifeAtBranch.TryGetValue(flStem, out var lifeDict) && lifeDict.TryGetValue(flBranch, out var ls))
                    {
                        string intensity = ls switch {
                            "帝旺" or "臨官" => "最強",
                            "長生" or "冠帶" => "旺盛",
                            "沐浴" or "養" or "胎" => "中等",
                            "衰" => "稍弱",
                        ...
                        if (stemIsGood)
                            brLines.Add(ls is "帝旺" or "臨官"
                                ? $"天干{flStem}（{flStemSS}）在地支{flBranch}達{ls}之位，喜用力量{intensity}，今年{flStemSS}的效益充分發揮，是最有力的一年。"
                                : ls is "墓" or "絕"
                                ? $"天干{flStem}（{flStemSS}）在地支{flBranch}入{ls}，喜用力量{intensity}，雖屬喜用但今年力道受壓，機緣仍有，需主動把握。"
                                : $"天干{flStem}（{flStemSS}）在地支{flBranch}處{ls}，喜用力量{intensity}，效益穩定展開。");
                        else if (stemIsBad)
                            brLines.Add(ls is "帝旺" or "臨官"
                                ? $"天干{flStem}（{flStemSS}）在地支{flBranch}達{ls}之位，忌神力量{intensity}，今年{flStemSS}的壓力最為強烈，需格外謹慎。"
                                : ls is "墓" or "絕" or "死"
                                ? $"天干{flStem}（{flStemSS}）在地支{flBranch}入{ls}，忌神力量{intensity}，壓力相對緩解，逆境中有所喘息。"
                                : $"天干{flStem}（{flStemSS}）在地支{flBranch}處{ls}，忌神力量{intensity}，壓力持續，宜謹慎。");
                        else
                            brLines.Add($"天干{flStem}（{flStemSS}）在地支{flBranch}處{ls}，力量{intensity}，中性影響平穩展開。");
                    }

                    // B2. 地支自身象法（五行方位）
                    if (LnBranchXiangDict.TryGetValue(flBranch, out var bxiang))
                        brLines.Add(bxiang.Desc);

                    // B3. 流年地支刑沖合破 vs 命局四柱地支 + 大運地支
                    var targets = new (string br, string ss, string pillarLabel, string domain)[]
                    {
                        (yBranch,      yBranchSS,   "年支",     "長輩家族宮"),
                        (mBranch,      mBranchSS,   "月支",     "父母事業宮"),
                        (dBranch,      "",           "日支",     "配偶宮"),
                        (hBranch,      hBranchSS,   "時支",     "子女晚輩宮"),
                        (daiyunBranch, daiyunBrSS,  "大運地支", "大運格局宮"),
                    };
                    foreach (var (tb, tss, tpl, tdom) in targets)
                    {
                        if (string.IsNullOrEmpty(tb)) continue;
                        string whoStr = tpl == "日支"
                            ? (isMale ? "配偶（妻）" : "配偶（夫）")
                            : string.IsNullOrEmpty(tss) ? tdom : $"{tdom}（{tss}）";
                        // 六沖
                        if (LfBranchChongOf.TryGetValue(flBranch, out var chongBr) && chongBr == tb)
                        {
                            brLines.Add($"流年{flBranch}沖{tb}（{tpl}·{whoStr}），今年此宮有重大異動，宜主動應對，謹慎決策。");
                            continue;
                        }
                        // 六合
                        if (LfHe.TryGetValue(flBranch, out var heInfo) && heInfo.partner == tb)
                        {
                            brLines.Add($"流年{flBranch}合{tb}（{tpl}·{whoStr}），今年此宮有和諧機緣，關係有好的進展。");
                            continue;
                        }
                        // 三刑
                        bool isXing = false;
                        foreach (var xg in LfXing)
                            if (xg.Contains(flBranch) && xg.Contains(tb) && flBranch != tb) { isXing = true; break; }
                        if (isXing)
                        {
                            brLines.Add($"流年{flBranch}刑{tb}（{tpl}·{whoStr}），今年此宮人際有衝突摩擦，宜留退路，避免正面衝突。");
                            continue;
                        }
                        // 六害
                        if (LfHai.Contains(flBranch + tb))
                            brLines.Add($"流年{flBranch}害{tb}（{tpl}·{whoStr}），今年此宮有潛在摩擦，人際往來需留意細節。");
                    }

                    if (brLines.Count > 0)
                    {
                        string brLabel = LnBranchXiangDict.TryGetValue(flBranch, out var bx) ? bx.ElemDir : "";
                        xiangSb.AppendLine($"  地支{flBranch}（{brLabel}）：");
                        foreach (var line in brLines) xiangSb.AppendLine($"  {line}");
                        xiangSb.AppendLine();
                    }
                }
            ...
            sb.AppendLine();
            sb.AppendLine("【3.1c 歲星臨命圖】");
            if (string.IsNullOrEmpty(mingGongChartText))
                sb.AppendLine("（命宮資料不足，無法計算歲星臨命圖）");
            else
                sb.AppendLine(mingGongChartText);
            sb.AppendLine();
            ...
            foreach (var m in monthlyDetails)
            {
                ...
                // crossLabel = cross評級 × 月干十神，每月個性化描述
                string crossLabel = (mStemSS2, m.cross) switch {
                    ("比肩", "大吉") => "同業合力，借勢崛起",
                    ("比肩", "吉")   => "同業共榮，合作順暢",
                    ("比肩", "小凶") => "同業競爭，低調保守",
                    ("比肩", "大凶") => "競爭激烈，守住根本",
