...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250826062647_AddIdentitySchema') THEN
...
BEGIN
    ...
    CREATE TABLE "Customers" (
        ...
        "BirthDateTime" timestamp with time zone NOT NULL,
...
BEGIN
    ...
    VALUES ('20250826062647_AddIdentitySchema', '9.0.8');
    END IF;
END $EF$;
COMMIT;
